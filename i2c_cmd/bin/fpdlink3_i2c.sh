...
write_rpi_init()
{
    ...
    i2cset -y $I2C_DEV $DES_ID 0x1f 0x02 
    i2cset -y $I2C_DEV $DES_ID 0x33 0x21 
    if [ $FPDLINK_PORT -eq 1 ] ; then
        i2cset -y $I2C_DEV $DES_ID 0x20 0x10 
        i2cset -y $I2C_DEV $DES_ID 0x4c 0x12 
    else
        i2cset -y $I2C_DEV $DES_ID 0x20 0x20 
        i2cset -y $I2C_DEV $DES_ID 0x4c 0x01 
    fi
    i2cset -y $I2C_DEV $DES_ID 0x6d 0x7c 
    i2cset -y $I2C_DEV $DES_ID 0x58 0x5e 

    i2cset -y $I2C_DEV $DES_ID 0x5c 0x32 

    i2cset -y $I2C_DEV $DES_ID 0x5d 0x76 
    i2cset -y $I2C_DEV $DES_ID 0x65 0x76 

    i2cset -y $I2C_DEV $DES_ID 0x06 0x00 
    i2cset -y $I2C_DEV $DES_ID 0x05 0x00 
    sleep 0.1;

    i2cset -y $I2C_DEV $SER_ID 0x02 0x52 
    i2cset -y $I2C_DEV $SER_ID 0x32 0x49 
    sleep 0.1;

    i2cset -y $I2C_DEV $SER_ID 0x39 0x60 
    i2cset -y $I2C_DEV $SER_ID 0x41 0x60 
...
backward_port0_pin1_init()
{
    ...
    i2cset -y $I2C_DEV $DES_ID 0x6E 0x10
...
write_sync_init()
{
    ...
    #i2cset -y $I2C_DEV $DES_ID 0x6F 0x32
}
